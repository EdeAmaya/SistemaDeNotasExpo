...
import { ArrowLeft, Users, UserCheck, Award, BookOpen, Target, Calendar, Layers, ChevronDown, ChevronUp, Hash, TrendingUp } from 'lucide-react';
    ...
    <div className="p-8 space-y-6">
      ...
      <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-xl p-6 text-white shadow-lg">
        <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 text-sm">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>{projectDetails.totalEvaluaciones} evaluaciones</span>
                </div>
              </div>
            </div>
          </div>
          <div className="text-right">
            ...
            <div className="text-5xl font-black">{projectDetails.promedioTotal.toFixed(5)}</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <button
          ...
          className={`cursor-pointer group relative overflow-hidden rounded-xl p-6 border-2 transition-all duration-300 ${
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <div className={`text-3xl font-black ${
                activeSection === 'internal' ? 'text-blue-600' : 'text-gray-700'
              }`}>
                {projectDetails.promedioInterno.toFixed(2)}
              </div>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <div className={`text-3xl font-black ${
                activeSection === 'external' ? 'text-purple-600' : 'text-gray-700'
              }`}>
                {projectDetails.promedioExterno.toFixed(2)}
              </div>
              <div className="text-xs text-gray-500 font-semibold">Promedio</div>
            </div>
          </div>
              ...
              {(activeSection === 'internal' 
                ...
                return (
                  <div key={evaluacion._id} className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                    {/* Header de la evaluación - Clickeable */}
                    <button
                          ...
                          <div className="flex items-center gap-3 text-sm text-gray-600">
                            {rubric?.stageId && (
                              <div className="flex items-center gap-1">
                                ...
                                <span>{rubric.stageId.name || rubric.stageId.stageName}</span>
                              </div>
                            )}
                            <div className="flex items-center gap-1">
                              <Target className="w-4 h-4" />
                            ...
                            <div key={idx} className="bg-white rounded-lg p-3 border border-gray-200">
                              <div className="flex items-start justify-between gap-3">
                                <div className="flex-1">
                                  ...
                                  {/* Mostrar peso si es Escala Estimativa */}
                                  {rubric?.rubricType === 1 && criterio.criterionWeight !== undefined && (
                                    <div className="flex items-center gap-1 text-xs text-purple-600 mt-1">
                                      <TrendingUp className="w-3 h-3" />
                                      <span className="font-semibold">Ponderación: {criterio.criterionWeight}%</span>
                                    </div>
                                  )}
                                ...
                                <div className="text-right flex-shrink-0">
                                  ...
                                  <div className="text-xs text-gray-500 font-semibold">/ 10.0</div>
                                </div>
                              </div>
                            </div>
                          ))}
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <div className="font-bold text-gray-800">
                                {evaluacion.tipoCalculo === 'ponderado' ? 'Promedio Ponderado' : 'Promedio Simple'}
                              </div>
                            </div>
                            <div className="text-right">
                              <div className="text-xs font-semibold text-gray-600 mb-1">
